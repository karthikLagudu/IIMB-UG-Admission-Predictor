...
export const IIMB_UG_ASSUMPTIONS = [
  "The cycle-specific procedure says at least 60% in Class X, while the current programme pages specify at least 60% in Class X Mathematics. The site's initial academic filter conservatively requires both.",
