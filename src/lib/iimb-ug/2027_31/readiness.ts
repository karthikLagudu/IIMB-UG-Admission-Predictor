...
export function calculateApplicationReadiness(
  ...
  return [
    ...
    item("class10Marks", "Class X marks", candidate.class10MathPercent == null ? "VERIFY" : !siteOverallPass || !mathPass ? "MISSING" : officialOverallPass ? "READY" : "VERIFY", candidate.class10MathPercent == null ? "Class X Mathematics marks are required to check the 60% Mathematics filter." : !siteOverallPass || !mathPass ? "The 60% Class X overall or 60% Mathematics requirement is not met." : officialOverallPass ? "Class X overall and Mathematics both meet the published 60% requirements." : "The Class X marks must be verified."),
