  ...
  return (
    <section className="ug-panel" aria-labelledby="ug-sources-heading">
      ...
      <div className="ug-assumption-grid">
        ...
        <div><h3>How to use the estimate</h3><ul><li>The 2027 interview-call cutoffs and test-score normalization are unavailable.</li><li>The displayed target uses an assumed 15% buffer and a linear profile adjustment. It is a planning estimate, not a guaranteed safe score.</li></ul></div>
      </div>
