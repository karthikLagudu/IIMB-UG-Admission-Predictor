  ...
  return (
    <section className="ug-panel" aria-labelledby="ug-sources-heading">
      ...
      <div className="ug-assumption-grid">
        ...
        <div><h3>How to use the estimate</h3><ul><li>The 2027 interview-call cutoffs and test-score normalization are unavailable.</li><li>The category’s estimated total uses an assumed 15% buffer; your profile points are subtracted to show the exam gap. It is not a guaranteed call cutoff.</li></ul></div>
      </div>
