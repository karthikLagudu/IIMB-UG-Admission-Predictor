  ...
  return (
    <section className="ug-panel" aria-labelledby="ug-sources-heading">
      ...
      <div className="ug-assumption-grid">
        <div><h3>What is published</h3><ul><li>The category-wise QADI and aggregate values are from the UG Test 2025 first shortlist.</li><li>VARC and LR percentile columns are “NA”; a positive raw score in all three sections is required.</li></ul></div>
        <div><h3>How to use the estimate</h3><ul><li>The 2027 interview-call cutoffs and test-score normalization are unavailable.</li><li>The category’s estimated total uses an assumed 15% buffer; your profile points are subtracted to show the exam gap.</li><li>Section targets split that exam gap by the 30:20:20 test weights. They are estimated weighted points, not sectional percentiles or guaranteed call cutoffs.</li></ul></div>
      </div>
