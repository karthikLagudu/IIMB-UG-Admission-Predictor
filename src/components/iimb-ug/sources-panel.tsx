  ...
  return (
    <section className="ug-panel" aria-labelledby="ug-sources-heading">
      ...
      <div className="ug-assumption-grid">
        ...
        <div><h3>What is not published</h3><ul><li>The 2027 category-wise interview-call cutoffs and test-score normalization are unavailable.</li><li>A historical first-shortlist benchmark cannot be converted into a guaranteed personalized safe score.</li></ul></div>
      </div>
