...
export function CandidateForm(props: CandidateFormProps) {
  ...
  const updateCategory = (value: string) => {
    setCandidate((current) => value === "PWD"
      ...
      : { ...current, category: value as IimbUgCandidateDraft["category"], pwd: false });
    props.clearIssue("category");
  };
