...
export function SensitivityAnalysis({ result }: { result: IimbUgPredictionResult }) {
  ...
  return (
    <section className="ug-panel" aria-labelledby="ug-sensitivity-heading">
      <div className="ug-panel-heading"><div><span>04 · Optimisation</span><h2 id="ug-sensitivity-heading">Where can your Pre-PI score improve most?</h2></div><IimbUgSourceBadge source="DERIVED" /></div>
      ...
      <p className="ug-panel-note">This compares score leverage in the transparent planning model. It is not an official marginal interview-call probability.</p>
    </section>
  );
}
