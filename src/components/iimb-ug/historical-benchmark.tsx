...
export function HistoricalBenchmark({ result }: { result: IimbUgPredictionResult }) {
  ...
  return (
    <section className="ug-panel ug-history-panel" aria-labelledby="ug-history-heading">
      <div className="ug-panel-heading"><div><span>05 · Context only</span><h2 id="ug-history-heading">Historical cutoff benchmark</h2></div><IimbUgSourceBadge source={historical.sourceType} /></div>
